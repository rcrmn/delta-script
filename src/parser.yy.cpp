...
static const char *const yytname[] =
{
  ...
  "BOOLEAN", "FUN", "VAR", "PROTOTYPE", "IF", "ELIF", "ELSE", "WHILE",
  "FOR", "IN", "BREAK", "CONTINUE", "RETURN", "END", "LEXER_ERR",
  "$accept", "start", 0
};
#endif
